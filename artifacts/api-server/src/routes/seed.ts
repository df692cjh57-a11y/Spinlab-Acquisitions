...
router.post("/seed", async (req, res) => {
  try {
    ...
    const [deal1] = await db.insert(dealsTable).values({
      ...
      grossRevenue: "450000",
      netIncome: "120000",
      sellerClaimedNetIncome: "120000",
      adjustedNetIncome: "145000",         // manual override (buyer-adjusted SDE)
      targetMultiple: "3.5",
      // Revenue detail (coin-only, no W&F/PD/commercial)
      vendingRevenue: "6000",
      otherRevenue: "8000",
      ...
      cleaning: "3600",
      accounting: "5000",
      licensesPermits: "1500",
      otherExpenses: "2000",
      // Buyer adjustments
      replacementManagerSalary: "18000",
      capexReserve: "12000",
      // Lease
      ...
      machineBrand: "Dexter",
      avgMachineAge: "16",
      percentMachinesNeedingReplacement: "100",
      averageWasherReplacementCost: "8000",
      averageDryerReplacementCost: "5000",
      installationBudget: "20000",
      capexContingencyPercent: "15",
      // Financing
    ...
    const [deal2] = await db.insert(dealsTable).values({
      ...
      grossRevenue: "380000",
      netIncome: "110000",
      sellerClaimedNetIncome: "110000",
      adjustedNetIncome: "135000",
      targetMultiple: "3.5",
      // Revenue detail
      washFoldRevenue: "104000",
      vendingRevenue: "8000",
      otherRevenue: "18000",
      // Expense detail (annual)
      payroll: "78000",
      ...
      otherExpenses: "2000",
      // Buyer adjustments
      replacementManagerSalary: "8000",
      maintenanceReserve: "6000",
      // Lease
      ...
      avgMachineAge: "8",
      percentMachinesNeedingReplacement: "20",
      averageWasherReplacementCost: "8000",
      averageDryerReplacementCost: "5000",
      installationBudget: "5000",
      capexContingencyPercent: "10",
      // Financing
      downPaymentPercent: "10",
      interestRate: "10",
      amortizationYears: "10",
      closingCostPercent: "3",
      workingCapitalReserve: "12000",
      // Operations
      cardOrCoin: "Card",
      washAndFold: true,
      pickupDelivery: false,
    ...
    const [deal3] = await db.insert(dealsTable).values({
      ...
      grossRevenue: "520000",
      netIncome: "155000",
      sellerClaimedNetIncome: "155000",
      adjustedNetIncome: "175000",
      targetMultiple: "3.5",
      // Revenue detail
      washFoldRevenue: "88000",
      pickupDeliveryRevenue: "45000",
      commercialRevenue: "62000",
      vendingRevenue: "10000",
      otherRevenue: "15000",
      // Expense detail (annual)
      payroll: "120000",
      monthlyRent: "8200",
      ...
      // Upside model
      washFoldRevenueIncrease: "20000",
      pickupDeliveryRevenueIncrease: "35000",
      commercialRevenueIncrease: "28000",
      priceIncreasePercent: "3",
      // Lease
      ...
      avgMachineAge: "10",
      percentMachinesNeedingReplacement: "30",
      averageWasherReplacementCost: "8000",
      averageDryerReplacementCost: "5000",
      installationBudget: "8000",
      capexContingencyPercent: "10",
      // Financing
      downPaymentPercent: "10",
      interestRate: "10",
